...
if ($_GET['submit']=="Submit"){
	...
	if (!empty($error_msg)){
		...
		header('Location: ../../../library/fpdf/fpdf181/tutorial/view_pdf_report_for_website_products_api.myself.php?start_date='.$from_date.'&end_date='.$to_date.'&secret_code=sadioiow8923inksk65xzdweXdj&worker_id='.$worker_id);
	}
}
// return;
...
<h3>View My Own Report / 查看我自己的报告</h3>
<p>Please specify the date range (Beijing Time): / 请选择开始日期和结束日期 (北京时间):</p>
