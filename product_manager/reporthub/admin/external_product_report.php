...
if ($_GET['submit']=="Submit"){
	...
	if (!empty($error_msg)){
		...
		header('Location: ../../../library/fpdf/fpdf181/tutorial/view_report_for_external_products.php?start_date='.$from_date.'&end_date='.$to_date.'&secret_code=sadioiow8923inksk65xzdweXdj');
	}
}
// return;
echo '<head>
