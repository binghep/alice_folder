<?php
      ...
      $db_port = 3307;
      $db_name = 'F14CS4131U110';
      $db_username = 'F14CS4131U110R';
      $db_password = 'readme';
?>
<!DOCTYPE html>
...
<html>
   ...
   <body>
      <?php
         ...
         // Connect to MySQL
         if ( !( $database = mysql_connect( "egon.cs.umn.edu:3307",
            "F14CS4131U110", "14322" ) ) )                      
            die( "Could not connect to database </body></html>" );
   
         // open Database with the table of books 
         if ( !mysql_select_db( "F14CS4131U110", $database ) )
