...
$curr_user->load_account($user_id);
// var_dump($curr_user);
// echo $curr_user->acc_login;
// echo $curr_user->is_admin;
if ($curr_user->is_admin==1){
	$is_admin=true;
}

if (!$is_admin){
	echo 'This page is open to admin only. Exiting...';
	exit;
}
?>
...
//-----------------------------------------------------------------------------------------
include_once 'views/standalone/inner.search_product.admin_version.block.php';
