...
class product{
    ...
    */
	...
	array("amazon"=>array("price"=>"$20","product_url"=>"http://www.amazon.com/water","shipping"=>"$3.99"),
			  "jd"=>array("price"=>"$20","product_url"=>"http://www.amazon.com/water","shipping"=>"Free Shipping")
	    );
	*/
