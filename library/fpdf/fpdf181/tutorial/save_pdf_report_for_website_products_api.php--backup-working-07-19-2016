...
$query="";
$query="select distinct  updated_sku from product_attibute_update_log where update_timestamp>=\"$formated_start_date\" and update_timestamp<=\"$formated_end_date\"+ INTERVAL 1 DAY ;";
...
$summary_bottom="We recommend ".count($recommended_products)." products.\nThe following are the number of products updated by each employee in this date range:\n";
